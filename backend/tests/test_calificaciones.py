...
def test_calificaciones_devuelve_unidades_del_periodo_actual(client, datos_academicos_basicos, auth_headers):
    ...
    assert body[0]["unidades"] == [92.0, 90.0, 94.0, None, None, None, None, None, None, None]
